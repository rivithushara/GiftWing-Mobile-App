...
Giftwing mobile application was designed to make gift-giving easier and more personalised by utilising AI chatbot technology-
to offer personalised gift recommendations based on the recipient's preferences and interests. In addition, the developed application allows users to manually- 
customise gifts according to their own preferences.


# How to install Giftwing APK
*************************************

1) Download the APK file into your mobile.

2) Find the APK file inside of your mobile.

3) Install the APK file.

4) When install is successfull, open the GiftWing app ready to use...!!
...
You can download the full source code the the apk file  from [here],
...
You can download the Thesis Report and the project Poster from [here],
