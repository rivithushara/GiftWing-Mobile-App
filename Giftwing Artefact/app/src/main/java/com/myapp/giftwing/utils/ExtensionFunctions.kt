...
import com.myapp.giftwing.models.BookmarkItemWithProduct
import com.myapp.giftwing.models.CartItem
import com.myapp.giftwing.models.CartItemWithProduct
import com.myapp.giftwing.models.LocalManufacturer
import com.myapp.giftwing.models.LocalProduct
import com.myapp.giftwing.models.Manufacturer
import com.myapp.giftwing.models.Product
import com.myapp.giftwing.models.ProductDetails
import com.myapp.giftwing.sealed.DataResponse
import com.myapp.giftwing.sealed.AllError
import com.myapp.giftwing.sealed.Orientation
...
fun <T> Throwable.handleResponseException(): DataResponse<T> {
    return when (this) {
        ...
        is ClientRequestException -> {
            DataResponse.Error(allError = AllError.Network)
        }
        is ServerResponseException -> {
            DataResponse.Error(allError = AllError.Unknown)
        }
        else -> {
            DataResponse.Error(allError = AllError.Network)
        }
